...
<table class="table">
    ...
    <tbody>
        <?php foreach ($team_all as $dt) {?>
            <tr>
                <td><?=$dt['Worker_id'];?></td>
                <td><?=$dt['Worker_info'];?></td>
                <td><?=$dt['Worker_role'];?></td>
                <td><a href="update.php?id=<?=$dt['Worker_id'];?>&table_name=<?=$table_name;?>">update</a></td>
                <td><a href="delete.php?id=<?=$dt['Worker_id'];?>&table_name=<?=$table_name;?>">delete</td>
            </tr>
        <?php }?>
    </tbody>
</table>
<h3>ADD NEW DATA</h3>
<form class="form" action="admcreate.php" method="post">
    <input type="hidden" name="table_name" value="<?=$table_name;?>">
    <div class="form__item">
        <p>Worker_info</p>
        <input type="text" name="Worker_info">
    </div>
    <div class="form__item">
        <p>Worker_role</p>
        <input type="text" name="Worker_role">
    </div>
