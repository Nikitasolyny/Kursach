...
<body>
    ...
    <section class="hero-section">
        <div class="hs-slider owl-carousel">
            <?php foreach ($port as $dutu) { ?>
            <div class="hs-item set-bg" data-setbg="<?= $dutu['img1']; ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
                                <h2>Photo By <?= $dutu['Whosportfolio']; ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php foreach ($port as $dutu) { ?>
            <div class="hs-item set-bg" data-setbg="<?= $dutu['img2']; ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
            ...
            <?php foreach ($port as $dutu) { ?>
            <div class="hs-item set-bg" data-setbg="<?= $dutu['img3']; ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
